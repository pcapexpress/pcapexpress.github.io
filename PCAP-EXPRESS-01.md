...
We have established that a company employee (**host:DESKTOP-L8C5GSJ**) has clicked<br>
on a link taking them to a fake domain (**google-authenticator[.]burleson-appliance[.]net**)<br>
...
The network traffic indicates that some form of persistence has been established<br>
and that the infected host is communicating with the adversary<br>
